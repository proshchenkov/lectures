...
- [1 Системный анализ предметной области](#1-Системный-анализ-предметной-области)
   + [1.1 База данных (БД) и система управления базой данных (СУБД)](#1.1-База-данных-(БД)-и-система-управления-базой-данных-(СУБД))
   + [1.2 Предметная область и ее описание](#1.2-Предметная-область-и-ее-описание)
   + [1.3 Инфологическое моделирование](#1.3-Инфологическое-моделирование)
   + [1.4 Даталогическое моделирование (иерархическая, сетевая, реляционная МД)](#1.4-Даталогическое-моделирование-(иерархическая,-сетевая,-реляционная МД))
   + [1.5 Понятие ключей](#1.5-Понятие-ключей)
   + [1.6 Виды связи](#1.6-Виды-связи)
   + [1.7 Целостность данных](#1.7-Целостность-данных)
