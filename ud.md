...
неповторимость значений в этом столбце
...
Важно - атрибуты не могут появляться дважды в одной и той же таблице под одним и тем же именем. Мигрированный ключ обязательно должен ???
...
Связь, когда вторичный ключ попадается в атрибуты первичного ключа второй сущности называется идентифицирующей.
...
- у главной таблицы (если не установлен специальный режим) нельзя изменить значение первичного ключа, если это значение присутствует в столбце вторичного ключа ???
...
- автоматическая установка значения NULL - при ???
- ???
