...
- Каштанов В.А. Теория надежноти сложных систем
...
<table>
    ...
    <tr>
        ...
        <tr>
        <td>Машинный</td>
        <td>Многоэлементность, конструктивные связи, взаимодействие структурных элементов (ветрянная мельница, двигатель, передача, рабочий орган) увеличение габаритных размеров и массы</td>
